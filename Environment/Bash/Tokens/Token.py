...
class Token:
    ...
    # returns length of flattened token list
    ...
    # returns all tokens in a list ofr the flattened token list
    ...
    # replaces a token at pos in flatened token list and returns
    # true if succesful. Also returns the global index at which this occurs.
    ...
    # replaces a token at pos in flatened token list with a list of tokens 
    # and returns true if succesful. Also returns the global index at which this occurs.
    ...
    # is this a valid index for current token lol
    def is_valid_base_idx(self,pos:int):
        return pos < len(self.token_list) and pos >= 0

    # Removes a token at pos from the flattened token list
